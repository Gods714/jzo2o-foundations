...
public class FirstPageServeController {
    ...
    @Resource
    private ServeAggregationService serviceAggregationService;
    ...
    public List<ServeSimpleResDTO> findServeList(@RequestParam("cityCode") String cityCode,
        ...
        return serviceAggregationService.findServeList(cityCode, serveTypeId, keyword);
    }
}